 ...
 * ─────────────────────────────────────────────────────────────
 * File        : emerge/src/app/project/solara/page.tsx
 * Route       : /project/solara
 * Description : Project detail — Solara CleanTech, Marrakech, score 64, not Sharia-compliant
...
const projectData: ProjectData = {
  ...
  docs: [
    ...
    fin: {
    valuation: { FR: "4M MAD", EN: "4M MAD", AR: "4 م. درهم" },
    equityOffered: { FR: "20%", EN: "20%", AR: "20%" },
    sharePrice: { FR: "100 MAD", EN: "100 MAD", AR: "100 درهم" },
    revenue: { FR: "280 000 MAD", EN: "280,000 MAD", AR: "280,000 درهم" },
    ebitda: { FR: "− 95 000 MAD", EN: "− 95,000 MAD", AR: "− 95,000 درهم" },
    marketSize: { FR: "6Md MAD", EN: "MAD 6Bn", AR: "6 مليار درهم" },
    marketGrowth: { FR: "+15% / an", EN: "+15% / year", AR: "+15% سنوياً" },
...
function PitchFilm({ title, lang }: { title: string; lang: Lang }) {
  ...
  return (
    <div style={{ position: "relative", borderRadius: "14px", overflow: "hidden", background: "#0f1923", aspectRatio: "16/9", cursor: "pointer" }}
      ...
      <img src={`/img/cover_solara.svg`} alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }} />
